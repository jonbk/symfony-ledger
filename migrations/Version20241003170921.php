...
final class Version20241003170921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE block (uuid UUID NOT NULL, timestamp DATE NOT NULL, action VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, date DATE NOT NULL, metadata JSON NOT NULL, previous_signature VARCHAR(255) DEFAULT NULL, signature VARCHAR(255) NOT NULL, PRIMARY KEY(uuid))');
